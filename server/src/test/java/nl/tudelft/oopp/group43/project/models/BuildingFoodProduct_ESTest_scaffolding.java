...
public class BuildingFoodProduct_ESTest_scaffolding {
    ...
    private static void initializeClasses() {
        org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BuildingFoodProduct_ESTest_scaffolding.class.getClassLoader(),
    ...
    private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException {
        mock(Class.forName("nl.tudelft.oopp.group43.project.models.Building", false, BuildingFoodProduct_ESTest_scaffolding.class.getClassLoader()));
        mock(Class.forName("nl.tudelft.oopp.group43.project.models.BuildingFoodProductId", false, BuildingFoodProduct_ESTest_scaffolding.class.getClassLoader()));
        mock(Class.forName("nl.tudelft.oopp.group43.project.models.FoodProduct", false, BuildingFoodProduct_ESTest_scaffolding.class.getClassLoader()));
    }

    private static void resetClasses() {
        org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BuildingFoodProduct_ESTest_scaffolding.class.getClassLoader());

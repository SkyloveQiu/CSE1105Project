...
public class JwtRespones_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(JwtRespones_ESTest_scaffolding.class.getClassLoader() ,
      "nl.tudelft.oopp.group43.project.payload.JwtRespones"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JwtRespones_ESTest_scaffolding.class.getClassLoader()); 

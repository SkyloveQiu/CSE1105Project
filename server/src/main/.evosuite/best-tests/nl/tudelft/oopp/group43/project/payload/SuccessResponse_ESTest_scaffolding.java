...
public class SuccessResponse_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SuccessResponse_ESTest_scaffolding.class.getClassLoader() ,
      "nl.tudelft.oopp.group43.project.payload.SuccessResponse"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SuccessResponse_ESTest_scaffolding.class.getClassLoader()); 
